...
#> 1 construct     0.004    0.000   0.004
#> 2     build     0.027    0.000   0.027
#> 3    render     0.040    0.000   0.039
#> 4      draw     0.019    0.001   0.019
#> 5     TOTAL     0.090    0.001   0.089
benchplot(ggplot(mtcars, aes(mpg, wt)) + geom_point() + facet_grid(. ~ cyl))
#>        step user.self sys.self elapsed
#> 1 construct     0.005    0.000   0.005
#> 2     build     0.028    0.001   0.027
#> 3    render     0.089    0.000   0.089
#> 4      draw     0.035    0.000   0.035
#> 5     TOTAL     0.157    0.001   0.156
